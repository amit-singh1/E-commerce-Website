		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<a href="index.php">
							<span class="fa fa-truck" aria-hidden="true"></span>Sign Out</a>
					</li>
					<li>
					...
					<li>
						<a href="#" data-toggle="modal" data-target="#myModal1">
							<span class="fa fa-unlock-alt" aria-hidden="true"></span> <b>Welcome</b> <?php echo $_SESSION['user'];?>
 </a>
					</li>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								...
								<li class="">
									<a class="nav-stylehead" href="contact.php">Our Products</a>
								</li>
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<a class="button2" href="contact.php">Shop Now </a>
					</div>
				</div>
			</div>
				...
				<div class="col-sm-5 address-right">
					<div class="col-xs-6 footer-grids">
						...
						<ul>
							...
							<li>
								<a href="product.html">Dry Fruits</a>
							</li>
							<li>
